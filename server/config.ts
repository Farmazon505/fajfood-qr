...
const envSchema = z.object({
  ...
  MAX_BOT_USERNAME: z.string().trim().optional().default(""),
  MAX_API_BASE_URL: z.string().url().default("https://platform-api2.max.ru"),
  MAX_CA_CERT_PATH: z.string().trim().optional().default(""),
  MAX_WEBHOOK_SECRET: z.string().trim().regex(/^[A-Za-z0-9_-]{5,256}$/).optional().or(z.literal("")).default(""),
  MAX_AUTO_SUBSCRIBE_WEBHOOK: z.enum(["true", "false"]).default("false"),
